...
@mcp.app.get("/") # Access the underlying FastAPI app of FastMCP
async def read_root():
    return {"message": "Welcome to the Gmail MCP Server! Navigate to /mcp for tools."}
# END ADDITION
...
if __name__ == "__main__":
    ...
    # Use the standard HTTP app for compatibility with langchain-mcp-adapters
